        ...
        <div className='flex items-center gap-4'>
            {
                ...
                :<buttton className="bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block cursor-pointer" onClick={()=>navigate("/login")}>Create account</buttton>
            }
